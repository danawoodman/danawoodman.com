...
<style lang="postcss">
	...
	.section-title {
		@apply text-lg uppercase font-bold border-b border-gray-200 pb-1 mt-6 mb-4;
	}

	.list {
		@apply list-[square] ml-6 my-3 leading-snug;
	}
	.list li {
		@apply text-gray-700 leading-snug my-2;
	}
	.list::marker {
		@apply text-gray-300;
	}
